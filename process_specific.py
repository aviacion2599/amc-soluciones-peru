...
if __name__ == "__main__":
    process_single_image(
        r"temp_gdrive\AMC-2000 _ linea esencial\FOTO PRINCIPAL.jpg",
        r"public\uploads\products\amc-2000\img-01.webp"
    )
    process_single_image(
        r"temp_gdrive\AMC-8200\ccb2c2f1-f981-4b2e-97d4-20f57900b009.jpg",
        r"public\uploads\products\amc-8200\img-01.webp"
    )
    print("Done")
