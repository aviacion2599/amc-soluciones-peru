  ...
  const cols: { title: string; links: { label: string; href: string }[] }[] = [
    {
      title: "Productos",
      links: [
        { label: "Contadoras de Billetes", href: "#productos" },
        { label: "Contadoras de Monedas", href: "#productos" },
        { label: "Clasificadoras", href: "#productos" },
        { label: "Detectores", href: "#productos" },
    ...
    },
    {
      ...
      links: [
        { label: "Reparación", href: "#servicio-tecnico" },
        { label: "Calibración", href: "#servicio-tecnico" },
        { label: "Diagnóstico", href: "#servicio-tecnico" },
        { label: "Mantenimiento Preventivo", href: "#servicio-tecnico" },
        { label: "Garantía", href: "#servicio-tecnico" },
      ],
    },
    {
      title: "Empresa",
      links: [
        ...
        { label: "Casos de Éxito", href: "#nosotros" },
        { label: "Blog", href: "#" },
        { label: "FAQ", href: "#" },
