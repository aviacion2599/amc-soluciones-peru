  ...
  return (
    ...
    >
      ...
      <Link
        href={detailHref}
        className={cn(
        "relative flex items-center justify-center product-img-bg overflow-hidden pt-8 pb-6 sm:pt-10 sm:pb-8",
      )}
      ...
      >
        ...
        {image ? (
          <img
            src={image}
            alt={name}
            className="w-full h-[150px] sm:h-[180px] lg:h-[200px] object-contain p-3 sm:p-6 lg:p-8 group-hover:scale-105 transition-transform duration-500"
            loading="lazy"
          />
        ) : (
          <img
