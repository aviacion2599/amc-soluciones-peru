...
const HERO_PRODUCTS = [
  ...
  {
    src: "/uploads/products/amc-cm3400-max/hero-v6.webp",
    model: "AMC-CM3400 MAX",
    tagline: "Más velocidad para grandes cantidades.",
    scale: "",
  },
  {
    src: "/uploads/products/amc-2000/hero-v6.webp",
    model: "AMC-2000",
    tagline: "Solución esencial para todo negocio.",
    scale: "",
  },
  {
    src: "/uploads/products/amc-9100/hero-v6.webp",
    model: "AMC-9100",
    tagline: "Máxima precisión y seguridad en detección.",
    scale: "",
  },
  {
    src: "/uploads/products/amc-8200/hero-v6.webp",
    model: "AMC-8200",
      ...
      <div className="container-amc relative pb-4 sm:pb-6 lg:pb-8">
        <div className="grid grid-cols-1 max-sm:landscape:grid-cols-2 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-20 items-center">
          ...
          >
            ...
            <div
              className="flex items-center justify-center gap-2 mt-4 max-sm:landscape:mt-0 sm:mt-6 w-full"
              role="tablist"
