...
export const CATEGORIES = [
  {
    ...
    description: "Conteo ultrarrápido con detección de falsos multi-sensorial UV, MG, IR, CIS, MT y OCR.",
    count: 3,
    featured: true,
  },
  {
  ...
  },
  {
    ...
    description: "Equipos accesibles con detección IR, MG, RGB, IR-IMAGE y Doble CIS para todo negocio.",
    count: 1,
    featured: false,
  },
] as const;
