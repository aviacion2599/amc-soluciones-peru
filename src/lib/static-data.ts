...
export const STATIC_PRODUCTS = [
  // ─── CONTADORAS DE MONEDAS ───
  {
    ...
    images: [
      { id: "img-1-1", url: "/uploads/products/amc-cm3400/hero-v6.webp", alt: "AMC-CM3400 vista frontal", isPrimary: true },
      ...
      { id: "img-1-5", url: "/uploads/products/amc-cm3400/img-05.webp?v=6", alt: "AMC-CM3400 detalle tolva", isPrimary: false },
      { id: "img-1-6", url: "/uploads/products/amc-cm3400/img-06.webp?v=6", alt: "AMC-CM3400 vista completa", isPrimary: false },
    ],
    videos: [
    ...
    features: [],
    specifications: [
      { group: "Rendimiento", key: "Velocidad", value: "Hasta 3,400 monedas/minuto", order: 0 },
      { group: "Rendimiento", key: "Modo de conteo", value: "Conteo por cantidad y valor", order: 1 },
      { group: "Rendimiento", key: "Capacidad de tolva", value: "Hasta 1,500 monedas", order: 2 },
      { group: "General", key: "Pantalla", value: "LCD", order: 3 },
      { group: "Funciones", key: "Programación", value: "Lotes (Batch)", order: 4 },
      { group: "Funciones", key: "Memoria", value: "Memoria de conteo", order: 5 },
      { group: "General", key: "Ajuste", value: "Ajuste de diámetro y espesor", order: 6 },
      { group: "Conectividad", key: "Puertos", value: "USB, LAN y RS232", order: 7 },
      { group: "Soporte", key: "Garantía", value: "18 meses", order: 8 },
    ],
    applications: [],
  },
  {
    ...
    brand: { slug: "amc", name: "AMC" },
    images: [
      { id: "img-2-1", url: "/uploads/products/amc-cm3400-max/hero-v6.webp", alt: "AMC-CM3400 MAX vista frontal", isPrimary: true },
      ...
      { id: "img-2-5", url: "/uploads/products/amc-cm3400-max/img-05.webp?v=6", alt: "AMC-CM3400 MAX ruedas", isPrimary: false },
    ],
    videos: [
      { id: "vid-amc-cm3400-max-1", url: "1Ga3gq9080BRqIF8qjxuUI2OZLSm97Uaz", provider: "gdrive", title: "AMC-CM3400 MAX en operación" }
    ],
    documents: [],
    features: [],
    specifications: [
      { group: "Rendimiento", key: "Velocidad", value: "Hasta 3,400 monedas/minuto", order: 0 },
      { group: "Rendimiento", key: "Modo de conteo", value: "Conteo por cantidad y valor", order: 1 },
      { group: "Rendimiento", key: "Capacidad de tolva", value: "Alta capacidad (hasta 10,000 monedas)", order: 2 },
      { group: "General", key: "Pantalla", value: "LCD", order: 3 },
      { group: "Funciones", key: "Programación", value: "Lotes (Batch)", order: 4 },
      { group: "Funciones", key: "Memoria", value: "Memoria de conteo", order: 5 },
      { group: "General", key: "Ajuste", value: "Ajuste de diámetro y espesor", order: 6 },
  ...
  // ─── LÍNEA ESENCIAL ───
  {
    ...
    brand: { slug: "amc", name: "AMC" },
    images: [
      { id: "img-3-1", url: "/uploads/products/amc-2000/hero-v6.webp", alt: "AMC-2000 vista frontal", isPrimary: true },
  ...
  // ─── CONTADORAS DE BILLETES ───
  {
    ...
    brand: { slug: "amc", name: "AMC" },
    images: [
      { id: "img-4-1", url: "/uploads/products/amc-3200/hero-v6.webp", alt: "AMC-3200 2CIS vista frontal", isPrimary: true },
  ...
  },
  {
    ...
    brand: { slug: "amc", name: "AMC" },
    images: [
      { id: "img-5-1", url: "/uploads/products/amc-8100/hero-v6.webp", alt: "AMC-8100 vista frontal", isPrimary: true },
    ...
    videos: [
      { id: "vid-amc-8100-1", url: "14WNgB0Si5O97zr1VowGIrJ4-pTfEXRKk", provider: "gdrive", title: "AMC-8100 en operación" }
    ],
    documents: [
  ...
  // ─── CLASIFICADORAS DE BILLETES ───
  {
    ...
    brand: { slug: "amc", name: "AMC" },
    images: [
      { id: "img-6-1", url: "/uploads/products/amc-8200/hero-v6.webp", alt: "AMC-8200 vista frontal", isPrimary: true },
  ...
  },
  {
    ...
    brand: { slug: "amc", name: "AMC" },
    images: [
      { id: "img-8-1", url: "/uploads/products/amc-9200/hero-v6.webp", alt: "AMC-9200 vista frontal", isPrimary: true },
    ],
    videos: [],
    documents: [
